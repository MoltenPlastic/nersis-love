...
local flags = {"-c","-fpic","-O2","-std=c++11","-I../liblove","-I../liblove/modules","-I../liblove/libraries","-I../libnersiscore","-I../luabridge","-I/usr/include/SDL2","-I/usr/include/lua5.1"}
local out = "../entitymodule.so"
